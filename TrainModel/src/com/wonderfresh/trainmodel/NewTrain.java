...
public class NewTrain extends javax.swing.JFrame {
    ...
    TrainModelTestTrain tclist = new TrainModelTestTrain();
    /**
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        TrainModel tm = new TrainModel(count, tclist);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(NewTrain.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
